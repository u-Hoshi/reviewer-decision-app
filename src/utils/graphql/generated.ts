...
export type InsertGroupMutation = {
  __typename?: "mutation_root"
  insert_group_one?:
    | { __typename?: "group"; id: number; name: string; slackUrl?: string | null | undefined }
    | null
    | undefined
}
...
export type UpdateUserByPkMutation = {
  __typename?: "mutation_root"
  update_users_by_pk?: { __typename?: "users"; id: string } | null | undefined
}
...
export function useInsertGroupMutation(
  baseOptions?: Apollo.MutationHookOptions<InsertGroupMutation, InsertGroupMutationVariables>
) {
...
export const InsertUserDocument = gql`
  mutation InsertUser($email: String!, $id: String!, $name: String!) {
    insert_users_one(object: { email: $email, id: $id, name: $name, profile_photo_url: "" }) {
      email
      name
      id
      profile_photo_url
...
export function useUpdateUserByPkMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateUserByPkMutation, UpdateUserByPkMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type UpdateUserByPkMutationOptions = Apollo.BaseMutationOptions<
 ...
 * });
 */
export function useUserByGroupIdQuery(
  baseOptions: Apollo.QueryHookOptions<UserByGroupIdQuery, UserByGroupIdQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<UserByGroupIdQuery, UserByGroupIdQueryVariables>(UserByGroupIdDocument, options)
}
export function useUserByGroupIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<UserByGroupIdQuery, UserByGroupIdQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
